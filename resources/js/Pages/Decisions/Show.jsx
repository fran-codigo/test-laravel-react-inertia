        ...
        <AuthenticatedLayout>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                                ...
                                {decision.user_has_voted && (
                                    <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4 flex items-center">
                                        ...
                                        <span className="text-green-700">
                                            Ya has votado en esta decisión
                                        </span>
                                    </div>
                                )}
                    ...
                    <CommentList decisionId={decision.id} reloadComments={reloadComments}/>
